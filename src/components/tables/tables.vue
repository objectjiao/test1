<template>
    <div class="dnc-table-wrap">
        ...
        <Page :total="totalCount" :page-size="pageSize" size="small" show-elevator show-sizer show-total
              :page-size-opts="pageSizeOpts" @on-change="onPageChanged" @on-page-size-change="onPageSizeChanged">
        </Page>
    ...
    export default {
        ...
        methods: {
            ...
            setDefaultSearchKey() {
                this.searchKey = '';
                if (this.columns[0]) {
                    if (this.columns[0].key !== "handle") {
                        this.searchKey = this.columns[0].key
                    } else {
                        if (this.columns.length > 1) {
                            this.searchKey = this.columns[1].key
                        }
                    }
                }
                // this.searchKey =
