    ...
    <Layout style="height: 100%" class="main">
        <Sider hide-trigger collapsible :width="256" :collapsed-width="64" v-model="collapsed" class="left-sider"
            ...
            <side-menu accordion ref="sideMenu" :active-name="$route.name" :collapsed="collapsed"
                ...
                <div class="logo-con">
                    <span v-show="!collapsed" class="spanTil maxTilSpan">上饶市中小微企业融资平台</span>
                    <span v-show="collapsed" class="spanTil">企业融资平台</span>
                </div>
            </side-menu>
        </Sider>
        <Layout>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            menuList() {
                let list = []
                let menuRoutList = this.$store.getters.menuList;
                menuRoutList.map((item) => {
